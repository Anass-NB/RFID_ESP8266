...
<head>
	...
	<title>Reports - Employee Time Tracking System</title>
</head>
...
<body>
	<div class="container">
		...
		<div class="card mb-4">
			...
			<div class="card-body">
				<form id="report-form" method="GET" action="reports.php">
					<div class="row">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="btn-group" role="group">
								<button type="button" class="btn btn-outline-secondary quick-date" data-days="7">Last Week</button>
								<button type="button" class="btn btn-outline-secondary quick-date" data-days="30">Last Month</button>
								<button type="button" class="btn btn-outline-secondary quick-date" data-days="90">Last 3 Months</button>
								<button type="button" class="btn btn-outline-secondary" id="current-month-btn">Current Month</button>
							</div>
		...
		<?php if ($reportData && $reportData['status'] === 'success'): ?>
			<div class="card mb-4">
				<div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
					<h4 class="mb-0">
						<?php if ($employeeId): ?>
							Report for <?php echo $reportData['data']['employee']['name']; ?>
						<?php else: ?>
				...
				<div class="card-body">
					...
					<div class="row mb-4">
						<div class="col-md-3 col-sm-6">
							<div class="stat-card present-card">
								...
								<span class="stat-label">of <?php echo $reportData['data']['summary']['total_days']; ?> working days</span>
							</div>
						</div>
						...
						<div class="col-md-3 col-sm-6">
							<div class="stat-card late-card">
								...
								<span class="stat-label">days arrived late</span>
							</div>
						</div>
					...
					<div class="row mb-4">
						...
						<div class="col-md-6">
							<div class="card">
								<div class="card-header bg-secondary text-white">
									<h5 class="mb-0">Daily Work Hours</h5>
								</div>
								<div class="card-body">
					...
					<div class="card">
						...
						<div class="card-body p-0">
							<div class="table-responsive">
								<table class="table table-striped mb-0" id="detailedReport">
									<thead>
										<tr>
											<th>Date</th>
											<th>Day</th>
									...
									<tbody>
										...
										?>
											<tr <?php if ($isWeekend) echo 'class="table-secondary"'; ?>>
												...
												<td>
													<?php echo $record ? formatTime($record['first_entry']) : '---'; ?>
												</td>
												<td>
													<?php echo $record ? formatTime($record['last_exit']) : '---'; ?>
												</td>
												<td>
